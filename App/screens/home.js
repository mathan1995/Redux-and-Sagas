...
import { addData } from "../components/actions"; //Importing Actions
import Data from "../mocks/instructions.json"; //Importing the Data from Mock Server
...
export default function Home(props) {
    ...
    const getData = () => {
        ...
        //OPTION 2 - API CALL
        /*If You are getting api from the url then follow up this casestudy*/
